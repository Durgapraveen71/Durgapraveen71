...
//6
function sol6(){
    var n = prompt("Please enter a number", "Any Number from 1-9")
...
function Praveen(x,y)
{
  ...
  var z0   =   Praveen( low1, low2);
  var z1   =   Praveen(low1+high1, low2+high2);
  var z2   =   Praveen(high1,high2);
